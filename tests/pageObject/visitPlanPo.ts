...
// ---MS--- //
export const login = {
  loginPageTitle: '.welcome-text',
  userName: '[data-i="username-input-element"]',
  password: '[data-i="password-input-element"]',
...
export const vpBasic = {
  ...
  vpSearchRow: '[class="trial-list-table next-gen-data-table-container"]'
 };
 
export const allButtons = {
  vpAddBtn: '[data-i="forms-add-button"]',
  vpAddFormsBtn: '.add-template-form',
  vpSaveBtn: '[id="template-save-btn"]',
  vpEclpseBtn: ':nth-child(4) > .Button-sc-mmede5-0',
  vpVerifyBtn: '.dropdown-content .dropdown-item-text',
  vpConfirmBtn: '[data-i="verify-visit-plan-modal-confirm-btn"]',
  vpCloseBtn: '[data-i="users-close-button"]'
};
...
export const vpForms = {
  ...
  associateForm: '.selectedWithoutLeft > .style__CheckboxContainer-sc-v8e7kn-4 > .checkbox-container > :nth-child(1) > .checkbox-component > .checkbox-field-wrapper > .field > label'
};
export const navbarOptions = {
  tenantDD: '[class="Select-placeholder"]',
  tenantName: '[class="Select-menu-outer"]',
  studyDD: '[class="Select-placeholder"]',
  studyName: '[class="Select-menu-outer"]',
  selectStudyRow: 'body > div.render-target > div > div > aside > nav > a:nth-child(3)',
  addVisitPlanTab: 'div.styles__NestedSideNavTabMenu-sc-1gn5n84-0.eLtsMt.nested-menu-visible > a:nth-child(5)'
};
